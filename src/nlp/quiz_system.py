...
class BasicQuizEngine:
    def __init__(self, db, user_id):
        ...
        self.conn = sqlite3.connect(f'{self.db_path}/quiz_data.db') #initialize sqlite3 model for generating and accessing database
        self._init_db()
    ...
    def generate_quiz_from_script(self, script_path: str, topic: str):        
        ...
        for chunk in chunks:
            ...
            try:
                ...
                self._store_question(question, topic)
            except:
                continue
    
    #This function will store a question generated into our database "questions" table
    def _store_question(self, question: dict, topic: str):
        cursor = self.conn.cursor()
        cursor.execute('''
            INSERT INTO questions (question, options, answer, concept, topic)
            VALUES (?, ?, ?, ?, ?)
        ''', (
            question['question'],
