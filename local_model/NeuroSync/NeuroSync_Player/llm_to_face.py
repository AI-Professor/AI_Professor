...
from kokoro_model.kokoro.pipeline import KPipeline
from langchain_community.vectorstores import FAISS 
from langchain_community.embeddings import OpenAIEmbeddings 

# Constants
USE_LOCAL_LLM = False      # Set to False to use OpenAI API
...
VOICE_NAME = 'Brian'
OPENAI_API_KEY = "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"  # Set your OpenAI API key in environment variables
...
def main():
    ...
    try:
        while True:
            ...
            full_response = stream_llm_chunks(user_input, chat_history, chunk_queue, config=llm_config, db=db)
