...
def run_audio_animation(audio_path, generated_facial_data, py_face, socket_connection, default_animation_thread, stop_default_animation):
    # --------------------------------------------------------------------
...
def run_audio_animation_from_bytes(audio_bytes, generated_facial_data, py_face, socket_connection, default_animation_thread, stop_default_animation):
    # --------------------------------------------------------------------
